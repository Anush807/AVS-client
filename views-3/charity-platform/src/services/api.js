...
export const beneficiaryAPI = {
  ...
  // NOTE: These endpoints need to be added to your backend
  // Add to benificieryRoute.js:
  // router.get('/my-requests', authMiddleware(['beneficiary']), getMyRequests);
  // router.get('/all', authMiddleware(['admin']), getAllRequests);
  getMyRequests: () => api.get('/beneficiary/my-requests'),
  getAllRequests: () => api.get('/beneficiary/all'),
};
...
export const volunteerAPI = {
  ...
  // NOTE: These endpoints need to be added to your backend
  // Add to volunteerRoute.js:
  // router.get('/my-tasks', authMiddleware(['volunteer']), getMyTasks);
  // router.get('/tasks', authMiddleware(['admin']), getAllTasks);
  getMyTasks: () => api.get('/volunteer/my-tasks'),
  getAllTasks: () => api.get('/volunteer/tasks'),
};
